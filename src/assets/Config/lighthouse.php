...
return [
    ...
    */
    ...
    'route' => [
        ...
        'middleware' => [
            ...
            \App\Http\Middleware\UniversalMiddleware::class,
        ],
    ...
    */
    ...
    'schema' => [
        ...
        'tenant' => base_path('graphql/Tenant/schema.graphql'),
        'central' => base_path('graphql/Central/schema.graphql'),
    ],
    ...
    */
    ...
    'namespaces' => [
        'models' => [
            'App', 'App\\Models\\Tenant','App\\Models\\Central',
        ],
